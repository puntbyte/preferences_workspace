...
class ExceptionHandler {
  ...
  static InvalidGenerationSourceError incorrectFactoryRedirect(ConstructorElement element) {
    return InvalidGenerationSourceError(
  ...
  static InvalidGenerationSourceError missingEntryAnnotation(ParameterElement element) {
    return InvalidGenerationSourceError(
  ...
  static InvalidGenerationSourceError unsupportedType(ParameterElement element) {
    return InvalidGenerationSourceError(
  ...
  static InvalidGenerationSourceError missingDefaultValue(ParameterElement element) {
    return InvalidGenerationSourceError(
  ...
  static InvalidGenerationSourceError privateConstructorNeeded(ClassElement element) {
    return InvalidGenerationSourceError(
