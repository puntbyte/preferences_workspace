...
abstract class SecureAppSettings with _$SecureAppSettings, ChangeNotifier {
  factory SecureAppSettings(
    ...
    // --- Authentication ---
    @PreferenceEntry(key: 'user_auth_token') final String? authToken,

    @PreferenceEntry(key: 'session_expiry') final DateTime? sessionExpiryDate,
    ...
    @PreferenceEntry(
      ...
      defaultValue: BiometricAuth.none,
    )
    ...
    // --- Sensitive Data ---
    @PreferenceEntry(key: 'payment_token') final String? paymentToken,
